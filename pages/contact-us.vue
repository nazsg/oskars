<template>
  <div class="contact">
    ...
    <form v-else>
      <div class="group g1">
        <label for="name">Name</label> <input type="text" v-model="info.name" id="name" />
      </div>
      <div class="group g1">
      ...
      <div class="group g2">
        ...
        <textarea id="message" cols="30" rows="10" v-model="info.message"></textarea>
      </div>
      <div class="antispam">
        <antispam
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.$axios
        .post('https://oskarsbarbers4men.co.uk/mailer2.php', this.info)
        .then(res => {
          if (res.data == 'Success') {
            this.formSubmitted = true
          } else {
            console.log(res.data)
            this.formResult = 'Sorry your message was not sent. Please try again later.'
          }
        })
    },
  },
