  ...
  <div>
    <div id="showcase">
      <div class="banner">
        ...
        <h2>
          by professional staff <br />
          for all styles <br /><br />Hair cuts, Shape-Ups, razo shave & hot towel, beard
          trim. No appointment needed, just pop in.
        </h2>
      </div>
    </div>
    <div class="section">&nbsp;</div>
    <v-parallax src="https://oskarsbarbers4men.co.uk/img/clock1a.jpg" height="600">
      <div id="opening-hours" itemscope itemtype="http://schema.org/openingHours">
    ...
    <div class="section">&nbsp;</div>
    <v-parallax height="700" src="https://oskarsbarbers4men.co.uk/img/scissors.jpg">
      <iframe
...
export default {
  head: {
    ...
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        hid: 'description',
        name: 'description',
        content: 'Barbers for men in the high street of Herne Bay in Kent.',
      },
    ],
  },
  data() {
  ...
  methods: {
    getHours() {
      this.$axios.get('https://oskarsbarbers4men.co.uk/indexAPI_hours.php').then(res => {
        this.hours = res.data
      })
    },
    getPrices() {
      this.$axios.get('https://oskarsbarbers4men.co.uk/indexAPI.php').then(res => {
